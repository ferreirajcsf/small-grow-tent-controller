...
|---|---|
| **Stage** | Sets the VPD target for the current growth phase |
...
When everything is within limits, the controller fine-tunes conditions by chasing the stage's VPD target within the configured deadband, using the heater, exhaust, humidifier, and dehumidifier as needed.
