...
SENSORS = [
    ...
    # Debug / diagnostics — hidden by default, enable manually in entity settings
...
# Keys that should be logged in long-term statistics
...
class GrowTentSensor(CoordinatorEntity, SensorEntity):
    ...
    def __init__(self, entry, coordinator, key, name, devcls, unit, is_debug):
        ...
        # Debug sensors are created but hidden from the default UI.
        # The user can enable them individually via Settings → Entities.
        if is_debug:
